...
export const CARD_DESIGNS = [
  ...
  { id: "jewelry-minimalist", label: "Jewelry Minimalist" },
  { id: "haute-couture", label: "Haute Couture" },
  { id: "artisan-roaster", label: "Artisan Roaster" },
  { id: "modern-apothecary", label: "Modern Apothecary" },
  { id: "luxury-cosmetics", label: "Luxury Cosmetics" },
  { id: "private-wealth", label: "Private Wealth" },
  { id: "layered-fintech", label: "Layered FinTech" },
  { id: "vinyl-producer", label: "Vinyl Producer" },
  { id: "michelin-chef", label: "Michelin Chef" },
  { id: "avant-garde-studio", label: "Avant-Garde Studio" },
  { id: "botanical-florist", label: "Botanical Florist" },
  { id: "cyberpunk-developer", label: "Cyberpunk Developer" },
  { id: "kinetic-typographer", label: "Kinetic Typographer" },
  { id: "urban-architect", label: "Urban Architect" },
  { id: "nature-preserve", label: "Nature Preserve" },
  { id: "tech-pioneer", label: "Tech Pioneer" },
  { id: "luxury-hotel", label: "Luxury Hotel" },
  { id: "artisan-baker", label: "Artisan Baker" },
...
export const TEMPLATE_DEFAULT_COLORS: Record<string, string> = {
  "avant-garde": "#d3684b",
  "swiss-grid": "#1a1a2e",
  "fintech": "#0f3460",
  "geometric": "#e76f51",
  ...
  "creator": "#533483",
  "oil-portrait": "#2d6a4f",
  "heritage-curator": "#8b5e3c",
  "swiss-brutalist": "#e63946",
  "jewelry-minimalist": "#c9a96e",
  "haute-couture": "#16213e",
  "artisan-roaster": "#6f4e37",
  "modern-apothecary": "#457b9d",
  "luxury-cosmetics": "#d4a574",
  "private-wealth": "#023047",
  "layered-fintech": "#2a9d8f",
  "vinyl-producer": "#264653",
  "michelin-chef": "#b8860b",
  "avant-garde-studio": "#e94560",
  "botanical-florist": "#2d6a4f",
  "cyberpunk-developer": "#6d6875",
  "kinetic-typographer": "#1d3557",
  "urban-architect": "#bc6c25",
  "nature-preserve": "#2d6a4f",
  "tech-pioneer": "#0f3460",
  "luxury-hotel": "#c9a96e",
  "artisan-baker": "#d3684b",
  "wellness-coach": "#457b9d",
  "fashion-designer": "#16213e",
  "private-banker": "#023047",
  "creative-director": "#533483",
};
...
export const MOCK_CONTACTS: Omit<SavedContact, "user_id">[] = [
  {
    ...
    card_design: "fintech", card_color: "#1d3557", category: "Company", career_tag: "Marketing", career_sub_tag: "Branding",
  ...
  },
  {
    ...
    card_design: "architect", card_color: "#533483", category: "Customers", career_tag: "Finance", career_sub_tag: "Investment",
  ...
  },
  {
    ...
    card_design: "avant-garde", card_color: "#2d6a4f", category: "Acquaintances", career_tag: "Technology", career_sub_tag: "Software Development",
  ...
  },
  {
    ...
    card_design: "geometric", card_color: "#e94560", category: "Services", career_tag: "Medical", career_sub_tag: "Surgery",
  ...
  },
  {
    ...
    card_design: "swiss-grid", card_color: "#0f3460", category: "Suppliers", career_tag: "Real Estate", career_sub_tag: "Commercial",
  ...
  },
  {
    ...
    card_design: "creator", card_color: "#264653", category: "Company", career_tag: "Marketing", career_sub_tag: "Advertising",
  ...
  },
  {
    ...
    card_design: "architect", card_color: "#023047", category: "Services", career_tag: "Legal", career_sub_tag: "Corporate Law",
  ...
  },
  {
    ...
    card_design: "geometric", card_color: "#bc6c25", category: "Neighbors", career_tag: "Hospitality", career_sub_tag: "Restaurant",
